...
parser = argparse.ArgumentParser(description="Programme pour la reconnaissance de la mire de calibration")

parser.add_argument("-d","--device", type=str, default="64mp" ,choices=["16mp","64mp"], help="Camera utilise [64mp] or [16mp]")
parser.add_argument("-m","--mode", type=str, default="autofocus" ,choices=["autofocus","camera","webcam"], help="Selectionne le mode de fonctionnement")
parser.add_argument("-t","--tourelle", action='store_true', default=False, help="Utilisation de la tourelle pour initialisation de la position")
...
while True: 
    ...
    #prendre une image
    if args.mode == "camera" or args.mode == "autofocus":
